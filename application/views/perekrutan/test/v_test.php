...
<!-- Page Heading -->
	  <div class="d-sm-flex align-items-center justify-content-between mb-4">
	    <h1 class="h3 mb-0 text-gray-800"><b>Test Bidang <?=ucfirst($test[0]->bidang); ?></b></h1>
	    <a href="#" class="d-none d-sm-inline-block btn btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Simpan</a>
	  </div>
	  <hr>
	<form action="<?=base_url('test/hasilTest/'.$test[0]->bidang) ?>" method="post">

	<?php foreach ($test as $no => $soal): ?>
